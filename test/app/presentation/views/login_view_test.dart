...
void main() {
  ...
  final passwordFinder = find.byKey(const Key("input-password"));
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.enterText(emailFinder, "eliezer@gmail.com");
  ...
  testWidgets("LoginView > invalid credentials", (tester) async {
    await _initView(tester);
